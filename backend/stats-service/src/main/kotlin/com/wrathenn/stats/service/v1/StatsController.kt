...
class StatsController(
    ...
    fun getAllStats(): List<Stat<*>> {
        ...
        val statsStr = objectMapper.writeValueAsString(stats).apply {
            logger.info("Stats as str: $this")
        }

        val statsBack: List<Stat<*>> = objectMapper.readValue<List<Stat<*>>>(statsStr).apply {
            logger.info("deserialized as: $this")
        }
        return stats
    }
}
